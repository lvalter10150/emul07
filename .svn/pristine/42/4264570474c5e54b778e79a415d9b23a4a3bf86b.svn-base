...
/* 23/04/24 | L.VALTER  |  0003  | Intégration des la lib SDL               */
/*----------+-----------+--------+------------------------------------------*/
...
{
  strncpy((char *)General_Info.F_Key[1], "cldCLOAD", 80);
  strncpy((char *)General_Info.F_Key[2], "locLOCATE", 80);
  strncpy((char *)General_Info.F_Key[3], "lstLIST", 80);
  strncpy((char *)General_Info.F_Key[4], "runRUN\r", 80);
  strncpy((char *)General_Info.F_Key[5], "nul", 80);
  strncpy((char *)General_Info.F_Key[6], "dat?DATE$\r", 80);
  strncpy((char *)General_Info.F_Key[7], "csaCSAVE", 80);
  strncpy((char *)General_Info.F_Key[8], "prtPRINT", 80);
  strncpy((char *)General_Info.F_Key[9], "slpSLEEP", 80);
  strncpy((char *)General_Info.F_Key[10], "cntCONT\r", 80);
  strncpy((char *)General_Info.F_Key[11], "nul", 80);
