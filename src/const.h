...
#define IT_RST_A    INT_RSTA
#define IT_RST_B    INT_RSTB
#define IT_RST_C    INT_RSTC

#define X07_RAM_SAVE_FILE "/tmp/x07_ram.bin"
#define X07_RAM_MAGIC "X07RAM1"
#define X07_RAM_MAGIC_LEN 7
#define X07_RAM_SAVE_SIZE END_RAM
