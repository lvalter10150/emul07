...
extern void DisplayReg(register Z80 *R);
...
void IntZ80(Z80 *R,word Vector)
{
  ...
  if((R->IFF&IFF_1)||(Vector==INT_NMI))
  {
    ...
    {
	  /* Code pour NSC800 */
	  case 0x003C: R->PC.W=0x003C; JumpZ80(0x003C); break; /* NSC800 RSTA */
      case 0x0034: R->PC.W=0x0034; JumpZ80(0x0034); break; /* NSC800 RSTB */
      case 0x002C: R->PC.W=0x002C; JumpZ80(0x002C); break; /* NSC800 RSTC */
